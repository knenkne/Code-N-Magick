...
window.Game = function () {
  ...
  Game.prototype = {
    ...
    setDeactivated: function setDeactivated(deactivated) {
     ...
     */
    initializeLevelAndStart: function initializeLevelAndStart(restart) {
     ...
     */
    pauseLevel: function pauseLevel(verdict) {
      if (verdict) {
     ...
     * @private
     */
    _pauseListener: function _pauseListener(evt) {
     ...
     */
    _drawPauseScreen: function _drawPauseScreen() {
      var message;
    ...
    _generateStatistics: function _generateStatistics(time) {
    ...
    _drawMessage: function _drawMessage(message) {
      var ctx = this.ctx;

      var drawCloud = function drawCloud(x, y, width, heigth) {
        var offset = 10;
        ctx.beginPath();
        ctx.moveTo(x, y);
     ...
     * @private
     */
    _preloadImagesForLevel: function _preloadImagesForLevel(callback) {
      ...
      var loadSprite = function loadSprite(sprite) {
     ...
     */
    updateObjects: function updateObjects(delta) {
      // Персонаж.
    ...
    /** @private */
    _initializeGameListeners: function _initializeGameListeners() {
      window.addEventListener('keydown', this._onKeyDown);
      window.addEventListener('keyup', this._onKeyUp);
    },

    /** @private */
    _removeGameListeners: function _removeGameListeners() {
