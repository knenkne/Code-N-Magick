...
var renderRect = function renderRect(ctx, x, y, color, width, height) {
  ctx.fillStyle = color;
  ctx.fillRect(x, y, width, height);
};

var renderCloud = function renderCloud(ctx, x, y, color, width, height, stepHeight) {
...
var renderText = function renderText(ctx, x, y, padding, color, font, messages) {
  ctx.fillStyle = color;
  ctx.font = font;
...
var renderName = function renderName(ctx, x, y, color, font, name, gap) {
  ctx.fillStyle = color;
  ctx.font = font;
  ctx.textBaseline = "hanging";
...
var getMaxElement = function getMaxElement(array) {
...
window.renderStatistics = function (ctx, names, times) {
  ...
  var _loop = function _loop(i) {
    ...
    var calculateX = function calculateX() {
